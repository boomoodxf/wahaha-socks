...
| ------------- | ----------- | ----------------------------------------- | --------------------------------------------- |
| `id`          | uuid        | Primary Key, Default: gen\_random\_uuid() | Unique identifier                             |
| `created_at`  | timestamptz | Default: now()                            | Record creation timestamp                     |
| `brand`       | text        | Nullable                                  | Brand name                                    |
| `item_no`     | text        | Nullable                                  | Item number/SKU                               |
| `crotch_type` | text        | Nullable                                  | Enum-like: 'T\_crotch', 'seamless', etc.      |
| `thickness`   | text        | Nullable                                  | Stores '1D', '5D' or numeric string           |
| `material`    | text        | Nullable                                  | Enum-like: 'velvet', 'core\_spun', 'xuedaili' |
